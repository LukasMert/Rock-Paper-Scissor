...
var elUserScore = document.getElementById('user-score');
var elCompScore = document.getElementById('comp-score');
...
var compare = function(choice1, choice2) {
    if (choice1 === choice2) {
        return result = ["Het resultaat is gelijk", "tie"];
    } else if (choice1 === "rock") {
        if (choice2 === "scissors") {
            console.log("5b. rock > scissors");
            return result = ["Steen wint, User", "user"];
        } else if (choice2 === "paper") {
            console.log("5c. paper > rock");
            return result = ["Papier wint, comp", "comp"];
        }
    } else if (choice1 === "paper") {
        if (choice2 === "rock") {
            console.log("5d. paper > rock");
            return result = ["Papier wint, User", "user"];
        } else if (choice2 === "scissors") {
            console.log("5e. scissors > paper");
            return result = ["Schaar wint, Comp", "comp"];
        }
    } else if (choice1 === "scissors") {
        if (choice2 === "rock") {
            console.log("5f. rock > scissors");
            return result = ["Steen wint, Comp", "comp"];
        } else if (choice2 === "paper") {
            console.log("5g. scissors > paper");
            return result = ["Schaar wint, User", "user"];
        }
    }
}
...
var rockBox = document.getElementById('r');
rockBox.addEventListener('click', function() {
    userChoice("rock");
}, false);

var paperBox = document.getElementById('p');
paperBox.addEventListener('click', function() {
    userChoice("paper");
}, false);
var scissorBox = document.getElementById('s');
